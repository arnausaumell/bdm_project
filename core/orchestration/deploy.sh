...
echo "   - All dependencies from requirements/orchestration.txt"
...
echo -e "${BLUE}Building and deploying the orchestration flow...${NC}"
docker build -t arnausau11/orchestration:latest -f core/orchestration/Dockerfile .
docker push arnausau11/orchestration:latest

# Run the Python script with the correct PYTHONPATH
python3 core/orchestration/from_external_to_landing.py
python3 core/orchestration/from_landing_to_trusted.py
python3 core/orchestration/from_trusted_to_exploitation.py
